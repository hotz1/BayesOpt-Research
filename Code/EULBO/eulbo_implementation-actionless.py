...
n_files = len(oper.listdir('./Code/EULBO/Sim-Results/20240702/Actionless/'))

# Save file locally
sim_df.to_csv(f"./Code/EULBO/Sim-Results/20240702/Actionless/Separate_Simulation_Results_Actionless_{n_files}.csv", index = False)
