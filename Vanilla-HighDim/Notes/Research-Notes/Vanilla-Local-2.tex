...
% &= 1 - \frac{1}{1 - \bsk_{01}^{2}}\left[\left(\bsk_{0*}^{2} - 2\bsk_{0*}\bsk_{1*} + \bsk_{1*}^{2}\right)+ 2(1-\bsk_{01})\bsk_{0*}\bsk_{1*}\right]\\
% &= 1 - \frac{2\bsk_{0*}\bsk_{1*}}{1 + \bsk_{01}} - \frac{(\bsk_{0*} - \bsk_{1*})^2}{1 - \bsk_{01}^{2}}
\end{align*}
